...
<?php if(!isset($permissions_result) || (isset($permissions_result) && $permissions_result == false)): ?>
    ...
    <?php if(isset($permissions_result)): ?>
        ...
        <?php if($language_folder_result != true): ?>
            <br><br><strong>The permissions on duet/server/application/language/ are incorrect. This folder should be 777</strong>
        <?php endif; ?>

        <?php if($build_folder_result != true): ?>
                <br><br><strong>The permissions on duet/server/application/language/en/build/ are incorrect. This folder should be 777</strong>
        <?php endif; ?>

        <?php if($build_file_result != true): ?>
            <br><br><strong>The permissions on duet/server/application/language/en/build/all.php are incorrect. This file should be 777</strong>
        <?php endif; ?>
